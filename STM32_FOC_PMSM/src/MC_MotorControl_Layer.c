...
{
  TB_Set_Delay_500us(FAULT_STATE_MIN_PERMANENCY);//延迟500us后运行 
  /* Main PWM Output Enable */
  TIM_CtrlPWMOutputs(TIM1, DISABLE);//PWM关闭输出
...
/*******************************************************************************
*函数名：mcl_chk_overtemp

*说明：返回true，如果对热电阻连接电压
