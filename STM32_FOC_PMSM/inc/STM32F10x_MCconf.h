...
#define NO_SPEED_SENSORS
  ...
  //#define VIEW_ENCODER_FEEDBACK //检测编码器反馈
...
#define DIFFERENTIAL_TERM_ENABLED //PID微分项的启用  
...
//#define FLUX_TORQUE_PIDs_TUNING  //磁通转矩PID整定
...
#define DAC_FUNCTIONALITY  //DAC功能启用
