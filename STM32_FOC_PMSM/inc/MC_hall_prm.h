...
/* HALL SENSORS PLACEMENT 霍尔传感器位置----------------------------------------------------*/
...
#define HALL_SENSORS_PLACEMENT DEGREES_60//这里是自己加上去的，可以省略与否需要自己试验
...
/* Max TIM prescaler ratio defining the lowest expected speed feedback 霍尔定时器检测位置时间预分频值*/
